...
namespace Biosensor_GUI
{
    public partial class Form1 : Form
    {
        ...
        */
        ...
        {
            string portName = "COM21"; // TODO: find the right port automatically
            serialPort = new SerialPort(portName, 115200);
            // TODO: write port settings explicitly (baud rate, data bits, parity, ...)
        ...
        */
        ...
        private void UpdateDataStreamPlot(string data)
        {
            ...
            if (res)
            {
                ...
                dataPlot.Plot.Axes.SetLimits(0, dataPointsMax, dataYmin, dataYmax);
            }
        }
        ...
        private void StartBtn_Click(object sender, EventArgs e)
        {
            if (serialPort != null && serialPort.IsOpen)
            {
                ...
                try
                {
                    ...
                    textBoxLog.AppendText("Sent START cmd" + Environment.NewLine);
